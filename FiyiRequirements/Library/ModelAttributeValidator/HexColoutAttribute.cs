...
namespace FiyiRequirements.Library.ModelAttributeValidator
{
    public class HexColourAttribute : ValidationAttribute
    {
        ...
        public HexColourAttribute(string PropertyName, bool Required, string HexColourMinInStringFormat = Constant.HexColourMINValue, string HexColourMaxInStringFormat = Constant.HexColourMAXValue)
        {
